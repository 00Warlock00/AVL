// one piece el mejor anime no leo lloros
#include <iostream>
#include <malloc.h>
#include <iomanip>
#include <cstring>
...
void listarTodosLosPasajeros(nodo *raiz)
{
    if (raiz == NULL)
    {
    ...
    // Recorrido inorden para listar los pasajeros de cada embarcación
    listarTodosLosPasajeros(raiz->izq);
    listarPasajeros(raiz);
    listarTodosLosPasajeros(raiz->der);
}
